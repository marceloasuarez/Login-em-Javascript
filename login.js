...
btn_cancelar.addEventListener("click",(evt)=>{
			...
			sessionStorage.setItem("matlogado",""); 
			sessionStorage.setItem("nomelogado","");
			sessionStorage.setTtem("acessologado","");
	this.fechar();
});
...
/*<div id="fundoLogin" class="fundoLogin">
	<div id="baseLogin" class="baseLogin">
				...
				<div class="campoLogin">
					<label>Senha</label>
					<input type="text" name="f_senha" id="f_senha">
				</div>
			...
			<div id="logoLogin" class="logoLogin"><img src="./logo.jpg" title="CFBCursos"></div>		
	</div>
</div>*/
...
/* EXEMPLO DE API */ 
//APT devers retornar nome e acesso caso login seja efetuado com sucesso
//APT deveré retornar null caso login ndo seja efetuado 
